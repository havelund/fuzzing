...
<command_dictionary>
        ...
        <command_definitions>
          <fsw_command class="FSW" opcode="0x0001" stem="FUZZ_CMD_UNSIGNED_ARG_1">
            <arguments>
              <unsigned_arg bit_length="32" name="fuzz_cmd1_arg_1" units="seconds">
                <range_of_values>
                  <include max="800" min="1"/>
                </range_of_values>
                <description>First argument for fuzzing command 1.</description>
              </unsigned_arg>
              <unsigned_arg bit_length="16" name="fuzz_cmd1_arg_2" units="seconds">
                <range_of_values>
                  <include max="200" min="1"/>
                </range_of_values>
                <description>Second argument for fuzzing command 1.</description>
              </unsigned_arg>
              <unsigned_arg bit_length="8" name="fuzz_cmd1_arg_3" units="frames">
                <range_of_values>
          ...
          <fsw_command class="FSW" opcode="0x0002" stem="FUZZ_CMD_ENUM_2">
            <arguments>
              <enum_arg bit_length="8" enum_name="fuzz_enum_def1" name="fuzz_cmd2_arg_1">
                <description>First argument for fuzzing command 2.</description>
              </enum_arg>
              <enum_arg bit_length="8" enum_name="enable_disable" name="fuzz_cmd2_arg_2">
                <description>enable or disable selection</description>
              </enum_arg>
            </arguments>
            <description>Fuzzing command 2 with enum as argument.</description>
          </fsw_command>
          <fsw_command class="FSW" opcode="0x0003" stem="FUZZ_CMD_STRING_3">
            ...
            <completion>When command completes.</completion>
          </fsw_command>
